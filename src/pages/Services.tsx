        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          >
            <div className="grid md:grid-cols-[3fr_2fr] gap-10 items-center">
              ...
              <div className="bg-gradient-to-br from-primary/10 to-secondary/20 rounded-2xl p-3 flex items-center justify-center w-[79%] mx-auto ml-[calc(7%+20px)]">
                <img
                  ...
                  className="w-full h-full object-cover rounded-xl shadow-soft max-h-[253px]"
                  loading="lazy"
                />
              </div>
            </div>
